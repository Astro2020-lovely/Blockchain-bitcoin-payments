...
<link href="assets/example_4.css" rel="stylesheet">


<div class="container">
    <div class="card card-container">
        <img src="https://chart.googleapis.com/chart?chs=125x125&cht=qr&chl=bitcoin:<?= $payTo ?>?amount=<?= $amount ?>&choe=UTF-8" id="profile-img"   class="profile-img-card" >
        <p id="profile-name" class="profile-name-card"></p>
        <form class="form-signin">
            <span id="reauth-email" class="reauth-email"></span>
            <input type="text" id="address_<?= $orderID ?>" class="form-control" value="<?= $payTo ?>" onclick="this.select();" autofocus readonly>
            <small class="text text-default">
              Simply scan QR Code with your mobile device or copy one in the input box<br/>
            </small>
